...
{
    public class QueryStringHttpRouteConstraint : IQueryStringRouteConstraint, IHttpRouteConstraint
    {
        private readonly IHttpRouteConstraint _constraint;

        public QueryStringHttpRouteConstraint(IHttpRouteConstraint constraint)
        {
