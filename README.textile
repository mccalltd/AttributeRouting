h2. Please refer to the "wiki pages":http://wiki.github.com// for documentation.

*If you encounter any issues using this library, please log them in the "issue tracker":https://github.com//issues. Thanks.*

h3. NOTE: AttributeRouting WILL NOT WORK with Web API RTM! But I am working with Microsoft on fixing the issues, and AR will, one day soon, fully support it. In the meantime, everything’s still peachy with MVC.
