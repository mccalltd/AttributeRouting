...
{
    public class CompoundHttpRouteConstraintWrapper : ICompoundRouteConstraintWrapper, IHttpRouteConstraint
    {
        private readonly IHttpRouteConstraint[] _constraints;

        public CompoundHttpRouteConstraintWrapper(params IHttpRouteConstraint[] constraints)
        {
