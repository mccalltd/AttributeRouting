...
{
    public class OptionalRouteConstraintWrapper : IOptionalRouteConstraintWrapper, IHttpRouteConstraint
    {
        private readonly IHttpRouteConstraint _constraint;

        public OptionalRouteConstraintWrapper(IHttpRouteConstraint constraint)
        {
