...
{
    public class QueryStringHttpRouteConstraintWrapper : IQueryStringRouteConstraintWrapper, IHttpRouteConstraint
    {
        private readonly IHttpRouteConstraint _constraint;

        public QueryStringHttpRouteConstraintWrapper(IHttpRouteConstraint constraint)
        {
