...
#line hidden
        ...
        public virtual void GeneratingRoutesForAnActionMethod(string action, string method, string url)
        {
...
#line hidden
        ...
        public virtual void GeneratingRoutesForAnActionMethod_Index()
        {
            this.GeneratingRoutesForAnActionMethod("Index", "GET", "Index");
        }
        
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Generating routes for an action method")]
        public virtual void GeneratingRoutesForAnActionMethod_Create()
        {
            this.GeneratingRoutesForAnActionMethod("Create", "POST", "Create");
        }
        
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Generating routes for an action method")]
        public virtual void GeneratingRoutesForAnActionMethod_Update()
        {
            this.GeneratingRoutesForAnActionMethod("Update", "PUT", "Update/{id}");
        }
        
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Generating routes for an action method")]
        public virtual void GeneratingRoutesForAnActionMethod_Destroy()
        {
            this.GeneratingRoutesForAnActionMethod("Destroy", "DELETE", "Destroy/{id}");
        }
    }
}
#endregion
