...
namespace AttributeRouting
{
    ...
    /// </summary>
    public class AreaConfiguration<TController, TRoute, TRouteParameter, TRequestContext, TRouteData>
    {
        ...
        /// Helper for configuring areas when initializing AttributeRouting framework.
        /// </summary>
        public AreaConfiguration(string name, AttributeRoutingConfiguration<TController, TRoute, TRouteParameter, TRequestContext, TRouteData> configuration)
        {
            _name = name;
